...
document.getElementById('textInput').value = 10; // display 10 char.s as default char on the input. 
// It ensures that the user sees an initial value instead of an empty field.
...
function generateNewPassword() {
  ...
  // it checks which character types the user has selected using checkboxes (checked property).
  ...
  // Define character sets for password generation, uppercaseChars this is variable. 
  ...
  let allChars = ''; // Initializes an empty string allChars
